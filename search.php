...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-156927896-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-156927896-4');
</script>
...
<a href="contact.php">Contact Sturtz Search</a>
</body>
</html>
